...
{
    public partial class FormVistaProveedor_Ingreso : Form
    {
        public FormVistaProveedor_Ingreso()
        {
            InitializeComponent();
        }
        ...
        private void OcultarColumnas()
        {
            try
            {
                // Mostrar solo columnas relevantes para ingresos
        ...
        private void FormVistaProveedor_Ingreso_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                DialogResult result = MessageBox.Show("¿Desea imprimir el reporte de proveedores para ingresos?",
                    "Sistema Campo Argentino",
                ...
                {
                    MessageBox.Show("Reporte de proveedores para ingresos generado exitosamente.\n\n" +
