...
namespace CampoArgentino.Presentacion
{
    public partial class FormVistaCliente_Venta : Form
    {
        ...
        private void OcultarColumnas()
        {
            try
            {
                // Mostrar solo columnas relevantes para ventas
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                DialogResult result = MessageBox.Show("¿Desea imprimir el reporte de clientes para ventas?",
                    "Sistema Campo Argentino",
                ...
                {
                    MessageBox.Show("Reporte de clientes para ventas generado exitosamente.\n\n" +
